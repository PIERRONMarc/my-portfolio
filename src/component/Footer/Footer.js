                ...
                <div className="footer__social-wrapper">
                    ...
                    <ul className="footer__social">
                        <li className="footer__social-item">
                            <a href="https://www.linkedin.com/in/marc-pierron" target="_blank" rel="noreferrer noopener"><FontAwesomeIcon icon={faLinkedin} /></a>
                        </li>
                        <li className="footer__social-item">
                            <a href="https://github.com/PIERRONMarc" target="_blank" rel="noreferrer noopener"><FontAwesomeIcon icon={faGithubSquare} /></a>
                        </li>
                    </ul>
